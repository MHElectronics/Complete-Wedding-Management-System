...
<html lang="en">
	...
	<body>
				...
				<div class="col-md-9">
				  ...
				  <table class="table">
					<tr>
					  ...
					  <td><?php echo $customer_info['cname']; ?></td>
					</tr>
					<tr>
					  <th width="150" class="text-right">Password :</th>
					  <td><?php echo $customer_info['pass']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Address :</th>
					  <td><?php echo $customer_info['caddress']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Phone :</th>
					  <td><?php echo $customer_info['cph']; ?></td>
					</tr>
		...
		<button type="submit" class="btn btn-primary">Edit</button>  
			...
			<br>
			 <a href="../index.html"  class="btn btn-info" role="button">Log Out</a>
